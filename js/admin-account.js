        ...
        if (user) {
            ...
            get(userRef).then((snapshot) => {
                if (snapshot.exists()) {
                    ...
                    fullNameElem.textContent = `${adminData.firstName} ${adminData.middleName} ${adminData.lastName}`;
                    fullNameDetailElem.textContent = `${adminData.firstName} ${adminData.middleName} ${adminData.lastName}`;
                    addressElem.textContent = adminData.address;
                    contactNumberElem.textContent = adminData.contactNumber;
                    usernameElem.textContent = adminData.username;
                    ...
                    console.error("No admin found for this user ID.");
                }
            }).catch((error) => {
